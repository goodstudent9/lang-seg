...
def forward_vit(pretrained, x, backbone):
    ...
    layer_1 = pretrained.activations["1"][0] #torch.Size([4, 901, 1024]) 576
    layer_2 = pretrained.activations["2"][0]
    layer_3 = pretrained.activations["3"][0]
    layer_4 = pretrained.activations["4"][0]
    # pdb.set_trace()
    layer_1 = pretrained.act_postprocess1[0:2](layer_1)
    layer_2 = pretrained.act_postprocess2[0:2](layer_2)
    layer_3 = pretrained.act_postprocess3[0:2](layer_3)
...
def forward_flex1(self, x, backbone):
    ...
    if backbone == "siglip_vitl16_384":
        ...
        # pos_embed = self._resize_pos_embed(
        #     self.pos, h // self.patch_size[1], w // self.patch_size[0]
        # )
        x = x + pos_embed
        x = self.pos_drop(x)
